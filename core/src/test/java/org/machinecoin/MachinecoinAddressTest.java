...
public class MachinecoinAddressTest {
    static final NetworkParameters mainParams = MachinecoinParams.get();
    ...
    public void errorPaths() {
        ...
        try {
            ...
            // Success.
            assertEquals(e.verCode, MachinecoinParams.get().getAddressHeader());
    ...
    public void getNetwork() throws Exception {
        ...
        assertEquals(MachinecoinParams.get().getId(), params.getId());
    }
}
